...
- **Save a copy of the audio** from the Audio tab — the whole recording or just the part you
  want, as a small `.m4a` to keep or send or as the original `.wav`. Converted on your
  machine with the encoder macOS already has.
